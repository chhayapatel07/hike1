	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
			    <a class="nav-link" href="employer.jsp"><li class="nav-item">Add_vacancy</li></a>
			    <a class="nav-link" href="recapplication.jsp"><li class="nav-item">Received_Application</li></a>						
